...
<p>Open the file in SWI then run those commands <img src="https://image.flaticon.com/icons/svg/0/656.svg" width="10" height="10" alt="Command Window free icon" title="Command Window free icon">:</p>
<ul>
